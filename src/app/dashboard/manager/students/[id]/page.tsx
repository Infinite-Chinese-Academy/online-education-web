          ...
          <Card>
            <Tabs defaultActiveKey="1" animated={true}>
              <Tabs.TabPane tab="About" key="1">
                ...
                <Row gutter={[6, 16]}>
                  <Col span={24} key="Education">
                    <StyledBold>Education:</StyledBold>
                    <span>{studentProfile?.education}</span>
                  </Col>
                  <Col span={24} key="Area">
                    <StyledBold>Area:</StyledBold>
                  ...
                  <Col span={24} key="Member Period">
                    <StyledBold>Member Period:</StyledBold>
                    <span>
                      {studentProfile?.memberStartAt} -{' '}
                      {studentProfile?.memberEndAt}
                    </span>
                  </Col>
                  <Col span={24} key="Type">
                    <StyledBold>Type:</StyledBold>
                    <span>{studentProfile?.type.name}</span>
                  </Col>
                  <Col span={24} key="Create Time:">
                    <StyledBold>Create Time:</StyledBold>
                    <span>{studentProfile?.createdAt}</span>
                  </Col>
                  <Col span={24} key="Update Time">
                    <StyledBold>Update Time:</StyledBold>
              ...
              <Tabs.TabPane tab="Courses" key="2">
                <Table
                  dataSource={studentProfile?.courses}
                  columns={columns}
                  rowKey="id"
                ></Table>
              </Tabs.TabPane>
