            ...
            renderItem={(item: Course, index) => (
              <List.Item
                ...
                extra={
                  <MyCountDown
                    ...
                    title={
                      isFuture(Date.now() + 1000 * 60 * 60 * 24 * 2 + 1000 * 30)
                        ? 'Countdown'
                        : 'In Progress'
                    }
              ...
              >
                <List.Item.Meta
                  ...
                  title={
                    <Link
                      href={`/dashboard/${storage?.userInfo?.role}/courses/${item.id}`}
                      passHref
                    >
                      {item.name}
                    </Link>
